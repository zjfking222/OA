...
<%
    ...
    if (formid != -1) {
        ...
        String yfkjpzh1 = map.get("yfkjpzh").toString();//应付会计凭证号
        String ck1 = map.get("ck").toString();//纸质发票号
        ...
        String yfkjpzh = map.get("yfkjpzh").toString();//应付会计凭证号
        String ck = map.get("ck").toString();//纸质发票号
...
<script type="text/javascript">
    ...
    function setDt1Data(dt1Data) {
        ...
        for (var i = 0; i < dt1Data.length; i++) {
            ...
            setFMVal(yfkjpzh1 + "_" + rowindex, lineData.LFBNR);//应付会计凭证号
            setFMVal(ck1 + "_" + rowindex, lineData.XBLNR);//参考
    ...
    function setDt2Data(dt2Data) {
        ...
        for (var i = 0; i < dt2Data.length; i++) {
            ...
            setFMVal(yfkjpzh + "_" + rowindex, lineData.LFBNR);//应付会计凭证号
            setFMVal(ck + "_" + rowindex, lineData.XBLNR);//参考
