...
//HR流程
	...
	String leix1 = map.get("leix1").toString();//请假类型
...
jQuery(function(){
	jQuery("#field"+leix1).bindPropertyChange(function() {
		getShis();
	});
...
function getShis(){
     ...
     var h_leix1 = jQuery("#field"+leix1+" option:selected").text();
     if(h_leix1==''){
    	 h_leix1 = jQuery("#disfield"+leix1+" option:selected").text();
     }
     if(h_yuangbh=="" || h_ksrq=="" || h_kssj==":" || h_jsrq=="" || h_jssj==":"|| h_leix1==""){
     	return;
     }else{
    	jQuery.ajax({
     		url:"/ajaxOperation/GetTime.jsp",
   	 		async:false,
   	 		type:"post",
   	 		data:{"operation":"time","h_yuangbh":h_yuangbh,"h_ksrq":h_ksrq,"h_kssj":h_kssj,"h_jsrq":h_jsrq,"h_jssj":h_jssj,"h_leix":h_leix1},
