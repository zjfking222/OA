...
@XmlRootElement(name = "erpPaymentData")
public class ErpPaymentData {

    @XmlElementRef(name = "jsonStr", namespace = "http://server.webservice.hygy.erp.hibernate.byttersoft.com", type = JAXBElement.class, required = false)
