...
public class hetong implements Action {
    public String execute(RequestInfo requestInfo){
        ...
        String name1=rs1.getString("name1");//供应商
        new BaseBean().writeLog ("name1"+name1);

        int BFS=0;//BFS开户行
        new BaseBean().writeLog ("BFS"+BFS);

        String sqfkje=rs1.getString("sqfkje");//申请付款金额
        new BaseBean().writeLog ("yingfje"+sqfkje);
        ...
        jsonObj.put("OPP_ACC_NAME",name1);
