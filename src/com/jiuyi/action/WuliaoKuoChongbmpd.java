 ...
 *
 */
public class WuliaoKuoChongbmpd extends BaseAction implements Action {
    public String execute(RequestInfo requestInfo){
        ...
        try {
            ...
            String sql = "select MATNR,MAKTX,WERKS from "+tablename+"_dt1 where mainid="+mainid+" and (cjjg is null or cjjg='')";
            ...
            while(rs.next()){
                ...
                if(E_FLAG.equals("1")){
                    ...
                    requestInfo.getRequestManager().setMessagecontent("提交失败:"+MATNR+"此物料编码在"+WERKS+"已存在，请更换");
                    return "0";
                }
            }
