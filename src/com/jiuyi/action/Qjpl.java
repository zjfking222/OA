 ...
 *
 */
public class Qjpl extends BaseAction{
	 public String execute(RequestInfo requestInfo) {
			...
			String functionName="ZHR_OE002_ABSENCE_CRD";//函数的名字
			...
			while(rs.next()){
				...
				AWART=Util.null2String(TransUtil.getQjLxWzh(rs.getString("leix")));//
